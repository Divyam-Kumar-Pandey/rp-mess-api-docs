...
- Params:
  ...
  - `foodType` (optional): Accepts values `VEG`, `NON-VEG`
  - `category` (optional): Accepts values `MAIN_COURSE`, `COMMON`
### Response
...
- Body:
  ```json
  {
    ...
    "imgURL": "https://www.imgurl.com/q.png", (optional)
    "foodType": "VEG",                        (optional)
    "category": "MAIN_COURSE"                 (optional)
  }
  ```
